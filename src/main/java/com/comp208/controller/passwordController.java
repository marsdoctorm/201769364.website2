...
import com.comp208.implementation.UserPasswordService;
...
public class passwordController {
    ...
    private boolean checkCodePhone(String codePhone, HttpServletRequest request) {
        Object codeObj = request.getSession().getAttribute("codePhone");
        if (null == codeObj)
            return false;
        String trueCodePhone = Convert.toStr(codeObj);
